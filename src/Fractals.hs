...
mandelbrotPoint :: Int -> Double -> Double -> Complex Double -> Maybe Double
mandelbrotPoint maxIterations power pixelSize point =
   antiAlias . normalize . iteratePoint $ point
 where
  maxMagnitude = 50
